  ...
  <select name=\"movie-genre\" id=\"movie-genre\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["genre"]) {
            // line 10
            echo "      <option value=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["genre"], "label", [], "any", false, false, true, 10), 10, $this->source), "html", null, true);
            echo "\">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["genre"], "label", [], "any", false, false, true, 10), 10, $this->source), "html", null, true);
            echo "</option>
    ";
