...
/* themes/contrib/danland/templates/menu.html.twig */
class __TwigTemplate_dc9ee512d7fbd4c2d6a0a2fe8a920cad814f45b56c7836d533397c9a77e6e859 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "menu menu-parent"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "is_expanded", [], "any", false, false, true, 41)) ? ("menu-item--expanded expanded") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,                     // line 42
$context["item"], "is_collapsed", [], "any", false, false, true, 42)) ? ("menu-item--collapsed collapsed") : ("")), 3 => ((twig_get_attribute($this->env, $this->source,                     // line 43
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail active-trail") : (""))];
                    // line 46
                    echo "      <li";
  ...
  ";
    ...
    {
        return "themes/contrib/danland/templates/menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% endif %}
{% endmacro %}
", "themes/contrib/danland/templates/menu.html.twig", "C:\\xampp\\htdocs\\drupal_first_test\\themes\\contrib\\danland\\templates\\menu.html.twig");
    }
