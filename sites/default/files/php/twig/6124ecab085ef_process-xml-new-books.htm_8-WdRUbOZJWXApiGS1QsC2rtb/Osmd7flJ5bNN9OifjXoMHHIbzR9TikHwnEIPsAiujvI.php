...
class __TwigTemplate_27540fb5c93090bf7ee8529eef1b849a3f356beeb5c8576e3358475756db04a0 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<h1>Loaded new books reviews:</h1>
<br>
";
        // line 3
    ...
    ";
            // line 8
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["book"], "field_book_comment", [], "any", false, false, true, 8), "value", [], "any", false, false, true, 8)) > 0)) {
                // line 9
                echo "      <p>Comment: ";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["book"], "field_book_comment", [], "any", false, false, true, 9), "value", [], "any", false, false, true, 9), 9, $this->source), "html", null, true);
                echo " </p>
    ";
            }
            // line 11
...
";
    ...
    {
        return array (  70 => 11,  64 => 9,  62 => 8,  58 => 7,  54 => 6,  50 => 5,  47 => 4,  43 => 3,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<h1>Loaded new books reviews:</h1>
<br>
{% for book in books %}
  <div class=\"book-item\">
    ...
    {% if book.field_book_comment.value|length > 0 %}
      <p>Comment: {{ book.field_book_comment.value }} </p>
    {% endif %}
  </div>
  <hr>
{% endfor %}
