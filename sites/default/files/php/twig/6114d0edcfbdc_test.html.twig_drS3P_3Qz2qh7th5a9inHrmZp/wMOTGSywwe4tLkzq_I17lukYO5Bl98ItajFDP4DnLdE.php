...
";
        // line 2
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Ajgl\Twig\Extension\BreakpointExtension']->setBreakpoint($this->env, $context), "html", null, true);
        echo "
<p>Value of variable var: ";
        // line 3
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["var"] ?? null), 3, $this->source), "html", null, true);
        echo "</p>
";
    }
...
", "modules/custom/controller/templates/test.html.twig", "C:\\xampp\\htdocs\\drupal_first_test\\modules\\custom\\controller\\templates\\test.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("breakpoint" => 2);
